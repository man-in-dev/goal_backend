...
import AITSVideoSolution from './src/models/AITSVideoSolution';
...
async function seedAITSData() {
  try {
    ...
    await AITSVideoSolution.deleteMany({});
    console.log('Existing data cleared.');
    
    console.log('Inserting AITS video solutions...');
    const inserted = await AITSVideoSolution.insertMany(aitsTestData);
