...
import spotTestVideoSolutionRoutes from './spotTestVideoSolution';
import reNeetVideoSolutionRoutes from './reNeetVideoSolution';
...
import neet2026AnswerKeyAccessRequestRoutes from './neet2026AnswerKeyAccessRequest';
...
router.use('/spot-test-video-solutions', spotTestVideoSolutionRoutes);
router.use('/re-neet-video-solutions', reNeetVideoSolutionRoutes);
...
router.use('/neet-2026-answerkey-access-request', neet2026AnswerKeyAccessRequestRoutes);
